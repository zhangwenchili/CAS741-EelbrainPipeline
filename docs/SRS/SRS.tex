...
\noindent \begin{itemize}
    ...
    \item[R\refstepcounter{reqnum}\thereqnum \label{R_BIDS}:] The input dataset should conform to BIDS format \citep{gorgolewski_et_al_2016}. If MRI data is provided, it be in FreeSurfer format.
