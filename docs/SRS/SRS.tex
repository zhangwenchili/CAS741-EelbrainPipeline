...
\hline
    ...
    & Structural MRI data are used to define the source space and to construct a geometrical head model, from which the linear forward operator $A$ is obtained. \\
    & The whitened forward operator $\tilde{A}$ is combined with the regularization parameter $\lambda$ to define the inverse operator $W$ as the closed-form solution of a regularized linear inverse problem. \\
